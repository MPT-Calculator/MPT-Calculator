...
if __name__ == '__main__':
   start_time = time();
   geometry = "CSG_Tetra.py"# "CSG_Knife_Knife_Santoku_carbonsteel_copper_rivets.py"
   CPUs=[6,6,6,6,6,6,6]
   for order in [0,1,2,3,4,5]:
       ...
       Return_Dict = main(geometry=geometry,use_POD=True,use_parallel=False,use_OCC=True,start_stop=(-3,12,500), MPT_Eigen=False, 
                        MPT_Eigen_From_POD=True, order=order,cpus=CPUs[order],  Time=np.logspace(-9,-2,300))

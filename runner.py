...
def main(h=2, order=2, curve_degree=5, start_stop=(), alpha='', geometry='default', frequency_array='default', use_OCC=False,
...
if __name__ == '__main__':
    ReturnDict = main(geometry='sphere_test.geo', h='coarse')

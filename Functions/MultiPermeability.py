...
class MultiParamSweep():
    ...
    def save_results(self, prefix='', suffix=''):
        ...
        foldername += f'_omega={self.frequency_array[0]:.2f}-{self.frequency_array[-1]:.2f}'
        ...
        foldername += f'_POD_omega={self.frequency_array_ROM[0]:.2f}-{self.frequency_array_ROM[-1]:.2f}'
        ...
        with open(__file__, 'r') as f:
            with open(foldername+'/main.py', 'w') as fout:
...
class PODP_ROM():
    ...
    def calc_error_bars_2(self):
        ...
        Mu0 = 4 * np.pi * 10 ** (-7)
        mur_dict = {'air': 1, 'ring': self.MPS.permeability_array[-1]}
        mur_dict = {'air': 1, 'ring': self.MPS.permeability_array[-1]}

...
if __name__ == '__main__':
   ...
   for order in [5]:
       ...
       for N in [100]:
           Return_Dict = main(geometry=geometry,use_POD=True, use_parallel=False, use_OCC=True, start_stop=(-3,12,N), MPT_Eigen=False,curve_degree=5,N_POD_points=50,MPT_Eigen_From_POD=True, SingleSVD=False, order=order, PODArray='default',cpus=CPUs[order], Amp_scale=2*np.pi*0.01**3,  Time=np.logspace(-6,-1,300))

...
src = r'GeoFiles/Ellipsoid_Minf_Gun.geo'
Add_material(src,subdomain_dict)
geo = CSGeometry(r'GeoFiles/Ellipsoid_Minf_Gun_append.geo')
...
nmesh.Save(r'VolFiles/CSG_ellipsoid_Gun_Minf.vol')

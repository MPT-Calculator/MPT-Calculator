...
tlo blade -col=[1,0,0]-material=carbon_steel ;#Blade -mur=5 -sig=1.6E+06
tlo heel -col=[0,1,0]-material=carbon_steel ;#Bolster -mur=5 -sig=1.6E+06
tlo tang -col=[0,0,1]-material=carbon_steel ;#Tang -mur=5 -sig=1.6E+06
tlo rivets -col=[1,1,0]-material=copper ;#Rivets -mur=1 -sig=5.8E+07
